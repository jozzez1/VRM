...
int main (int argc, char ** argv)
{
	...
	struct option longopts[] =
	{
		...
		{ "no-animate", no_argument,           &animate,  0 },
	...
	while ((arg = getopt_long (argc, argv, "l:M:m:h:d:n:J:j:v:a", longopts, NULL)) != -1)
	{
		switch (arg)
		{
			...
			case 1:
				...
				printf ("--min,      -m   minimum temperature\n");
